...
import 'package:jimmy_sir_app/features/tabbarcontroller/myWinsSection/presentation/widgets/bank_popup.dart';

class PayPalDetailsScreen extends ConsumerWidget {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            UrbanistApptext(
              text: AppText.paypalEmailAddress,
              fontSize: width * 0.04,
            ...
            AppTextField(
              ...
              hint: AppText.enterPaypalEmailAddress,
            ),
